                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a href="{{ route('single_page', ['slug' => $first_post->slug]) }}">{{ $first_post->title }}</a>
                                </h2>
                                ...
                                <div class="post-additional-info">
                                    ...
                                    <span class="category">
                                            ...
                                            <a href="{{ route('single_category', ['id' => $first_post->category->id]) }}">{{ $first_post->category->name }}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title ">
                                    <a href="{{ route('single_page', ['slug' => $second_post->slug]) }}">{{ $second_post->title }}</a>
                                </h2>
                                ...
                                <div class="post-additional-info">
                                    ...
                                    <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('single_category', ['id' => $second_post->category->id]) }}">{{ $second_post->category->name }}</a>
                                        </span>
                    ...
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title ">
                                    <a href="{{ route('single_page', ['slug' => $third_post->slug]) }}">{{ $third_post->title }}</a>
                                </h2>
                                ...
                                <div class="post-additional-info">
                                    ...
                                    <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('single_category', ['id' => $third_post->category->id]) }}">{{ $third_post->category->name }}</a>
                                        </span>
                ...
                <div class="container">
                    <div class="col-lg-12">
                        ...
                        <div class="offers">
                            ...
                            <div class="row">
                                <div class="case-item-wrap">
                                    @foreach($bootstrap->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $post->featured }}" alt="our case">
